...
Blockly.Python['lists_create_with_and'] = function(block) {
  // Create a list with any number of elements of any type.
  var elements = new Array(block.itemCount_);
  for (var i = 0; i < block.itemCount_; i++) {
    elements[i] = Blockly.Python.valueToCode(block, 'ADD' + i,
  ...
  var code = '[' + elements.join(', ') + ']';
  var final_code =  rizeBlocks.logic_all(code)
  return [final_code, Blockly.Python.ORDER_ATOMIC];;
};

Blockly.Python['lists_create_with_or'] = function(block) {
  // Create a list with any number of elements of any type.
  var elements = new Array(block.itemCount_);
  for (var i = 0; i < block.itemCount_; i++) {
    elements[i] = Blockly.Python.valueToCode(block, 'ADD' + i,
  ...
  var code = '[[' + elements.join('], [') + ']]';
  var final_code =  rizeBlocks.logic_either(code)
  return [final_code, Blockly.Python.ORDER_ATOMIC];;
};
